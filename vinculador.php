	...
	<div class="page-content" id="content">
		...
		<nav class="navbar background_gray sticky-top">
			...
			<div class="form-inline my-2 my-lg-0">
				<a class="nav-link d-sm-block d-lg-inline" href="vinculador.php"><i class="fas fa-home fa-lg fa-fw mr-1 text-orange"></i></a>
				...
				<div class="col">
					<div class="card shadow">
						<div class="card-header">
							¡Bienvenido Vinculador de <?php echo $_SESSION["Institucion_nombre"]; ?>!
						</div>
						<div class="card-body">
							<h5 class="card-title">Como Vinculador podrás hacer lo siguiente:</h5>
							<div class="card-text pl-3"><i class="fas fa-check mr-1 text-pale-green"></i>Completar o modifica tu perfil.</div>
							<div class="card-text pl-3"><i class="fas fa-check mr-1 text-pale-green"></i>Completar o modifica el perfil de tu Institución.</div>
							<div class="card-text pl-3"><i class="fas fa-check mr-1 text-pale-green"></i>Dar seguimiento a los avances de las Empresas Juveniles que JA México ha asignado a tu Institución, en todos sus planteles, para impulsar su desempeño.</div>
				...
				<div class="col-sm-4">
					<div class="card shadow">
						<div class="card-body">
							...
							<div class="text-right"><a href="vinculador/perfil.php" class="btn btn-warning">Perfil</a></div>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="card shadow">
						<div class="card-body">
							...
							<div class="text-right"><a href="vinculador/institucion.php" class="btn btn-warning">Institucion</a></div>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="card shadow">
						<div class="card-body">
							...
							<div class="text-right"><a href="vinculador/escuela.php" class="btn btn-warning">Escuela</a></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-sm-4">
					<div class="card shadow">
						<div class="card-body">
							...
							<div class="text-right"><a href="vinculador/calendario.php" class="btn btn-warning">Calendario</a></div>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="card shadow">
						<div class="card-body">
							...
							<div class="text-right"><a href="vinculador/empresas.php" class="btn btn-warning">Empresas</a></div>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
				...
				<div class="col-sm-4">
					<div class="card shadow">
						<div class="card-body">
							...
							<div class="text-right"><a href="vinculador/reportes.php" class="btn btn-warning">¡Adelante!</a></div>
						</div>
					</div>
				</div>
			</div>
