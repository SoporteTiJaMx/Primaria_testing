		...
		<div class="mx-5 mt-3">
			<div class="row">
				<div class="col">
					<div class="card shadow">
						...
						<div class="card-body">
							<h5 class="card-title">Como Administrador podrás hacer lo siguiente:</h5>
							...
							<div class="card-text pl-3"><i class="fas fa-check mr-1 text-pale-green"></i>Administrar las "Licencias de Operación" adquiridas.</div>
							<div class="card-text pl-3"><i class="fas fa-check mr-1 text-pale-green"></i>Configurar los detalles del Ciclo de Operación del programa.</div>
			...
			<div class="row mt-2">
				<div class="col-12 col-lg-4">
					<div class="card shadow">
						<div class="card-body">
							...
							<p class="card-text">Crea y administra los usuarios necesarios para la operación del programa.</p>
				...
				<div class="col-12 col-lg-4">
					<div class="card shadow">
						<div class="card-body">
							<h5 class="card-title"><i class="fas fa-cog mr-1 mr-3 text-pale-green"></i>Configuración</h5>
							<p class="card-text">Configura los etalles operativos del programa.</p>
							<div class="text-right"><a href="admin/configuracion.php" class="btn btn-warning">Configuración</a></div>
						</div>
					</div>
				</div>
			</div>
