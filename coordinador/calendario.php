...
<h5 class="text-center text-dark_gray pt-3 pb-1">
    <?php if (isset($_SESSION["licencia_nombre"])) { echo " Calendario operativo de Emprendedores y Empresarios: " . $_SESSION["licencia_nombre"] . "."; } else { echo "Actualmente tu escuela no participa del Programa Emprendedores y Empresarios"; } ?>
</h5>
