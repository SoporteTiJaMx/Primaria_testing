...
if(
	...
	if (isset($_SESSION['Escuela_ID'])) {
		...
		if ($stmt = $con->prepare($query)) {
			...
			$select_empresa.= "<option value='-1'>Todas las empresas</option>";
			while ($stmt->fetch()) {
		...
		$select_empresa = "<option value='0'>No tienes Empresas Juveniles en este ciclo del programa</option>";
	}
	echo $select_empresa;
} else {
