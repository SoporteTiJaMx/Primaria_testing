...
<div class="vertical-nav background_gradient navbar-expand-lg" id="sidebar">
	<div class="py-3 px-3 mb-3">
		<div class="media d-flex align-items-center"><img src="<?php echo $avatar . "?x=" . md5(time()); ?>" alt="foto de perfil" width="65" class="mr-3 rounded-circle img-thumbnail shadow-sm">
			<div class="media-body">
				...
				<p class="text-white w200 mb-0">Coordinador de <?php echo $_SESSION["Escuela_nombre"]; ?></p>
			</div>
		</div>
	</div>
	...
	<ul class="nav flex-column mb-0">
		<li class="nav-item <?php	if ($seccion == 'perfil') { echo 'active'; } ?>">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/perfil.php" class="nav-link text-white ml-3">
		...
		<?php if ($_SESSION["Institucion_ID"]>0) { ?>
		<li class="nav-item <?php	if ($seccion == 'institucion') { echo 'active'; } ?>">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/institucion.php" class="nav-link text-white ml-3">
				<i class="fas fa-place-of-worship fa-fw mr-3"></i>Datos de Institución
			</a>
		</li>
	<?php } ?>
		<li class="nav-item <?php	if ($seccion == 'escuela') { echo 'active'; } ?>">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/escuela.php" class="nav-link text-white ml-3">
				<i class="fas fa-school fa-fw mr-3"></i>Datos de Escuela
			</a>
		</li>
	</ul>
	<hr class="hr-white">
	...
	<ul class="nav flex-column mb-0">
		<li class="nav-item <?php	if ($seccion == 'calendario') { echo 'active'; } ?>">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/calendario.php" class="nav-link text-white ml-3">
				<i class="fas fa-calendar-alt fa-fw mr-3"></i>Calendario
			</a>
		</li>
		<li class="nav-item <?php	if ($seccion == 'empresas') { echo 'active'; } ?>">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/empresas.php" class="nav-link text-white ml-3">
				<i class="fas fa-industry fa-fw mr-3"></i>Empresas Juveniles
			</a>
		</li><?php /*
		<li class="nav-item <?php	if ($seccion == 'accesos_rapidos') { echo 'active'; } ?>">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/accesos_rapidos.php" class="nav-link text-white ml-3">
				<i class="fas fa-sign-in-alt fa-fw mr-3"></i>Accesos Rápidos
			</a>
		</li> */ ?>
		<li class="nav-item <?php if ($seccion == 'tablero_control') { echo 'active'; } ?>">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/tablero_control.php" class="nav-link text-white ml-3">
	...
	<ul class="nav flex-column mb-0">
		...
		<ul class="nav flex-column mb-0">
			<li class="nav-item <?php	if ($seccion == 'top3') { echo 'active'; } ?>">
				<a href="<?php echo $RAIZ_SITIO; ?>coordinador/top3.php" class="nav-link text-white ml-3">
					<i class="fas fa-star fa-fw mr-3"></i>TOP 3 EMPRESAS
				</a>
			</li>
			<li class="nav-item <?php	if ($seccion == 'financiamiento') { echo 'active'; } ?>">
				<a href="<?php echo $RAIZ_SITIO; ?>coordinador/financiamiento.php" class="nav-link text-white ml-3">
	...
	<ul class="nav flex-column mb-0">
		<li class="nav-item">
			<a href="<?php echo $RAIZ_SITIO; ?>coordinador/reportes.php" class="nav-link text-white ml-3">
...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			url: <?php echo "'" . $RAIZ_SITIO_nohttp . "coordinador/ajax/cintillo_sponsors_nacionales.php'";?>,
		...
		$.ajax({
			url: <?php echo "'" . $RAIZ_SITIO_nohttp . "coordinador/ajax/cintillo_sponsors_locales.php'";?>,
			success: function(data)
			{
