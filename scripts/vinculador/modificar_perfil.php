...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if (isset($_POST["csrf"]) && $_POST["csrf"] == $_SESSION["token"]) {
		$query = "UPDATE vinculadores SET Vincul_nombre=?, Vincul_ap_paterno=?, Vincul_ap_materno=?, Vincul_puesto=?, Vincul_email=?, Vincul_tel=?, Vincul_cel=?, Vincul_cumple=?, Vincul_estatus=? WHERE User_ID=?";
		...
		if ($estado) {
			...
			echo "<META HTTP-EQUIV='REFRESH' CONTENT='5;URL=../../vinculador/perfil.php'>";
					...
					<div class="col-6 mx-auto">
						<div class="card shadow">
							<div class="card-body">
								...
								<div class="text-right mt-5"><a href="../../vinculador/perfil.php" class="btn btn-warning">Ir</a></div>
							</div>
						</div>
					</div>
				</div>
...
<?php
			...
			echo "<META HTTP-EQUIV='REFRESH' CONTENT='5;URL=../../vinculador.php'>";
					...
					<div class="col-6 mx-auto">
						<div class="card shadow">
							<div class="card-body">
								...
								<div class="text-right mt-5"><a href="../../vinculador.php" class="btn btn-warning">Ir</a></div>
							</div>
						</div>
					</div>
				</div>
