...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if (isset($_POST["csrf"]) && $_POST["csrf"] == $_SESSION["token"]) {
		...
		if ($estado) {
			...
			echo "<META HTTP-EQUIV='REFRESH' CONTENT='5;URL=../../vinculador/institucion.php'>";
					...
					<div class="col-6 mx-auto">
						<div class="card shadow">
							<div class="card-body">
								...
								<div class="text-right mt-5"><a href="../../vinculador/institucion.php" class="btn btn-warning">Ir</a></div>
							</div>
						</div>
					</div>
				</div>
