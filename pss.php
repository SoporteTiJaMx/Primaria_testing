				...
				<div class="container-fluid">
					<div>
						...
						<form action="http://localhost/eye/scripts/pss.php" method="post" id="form_pss">
							...
							<h5 class="text-center text-white pb-2">Bienvenido(a) <?php echo $nombre . " " . $ap_paterno?>. Personaliza tu contraseña para ingresar a la plataforma.</h5>
							<div class="row">
								<div class="col-3"></div>
							...
							<div class="row mb-2 mt-3">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<small id="user_help" class="form-text text-white w300 text-center">Debe tener al menos 8 caracteres, letras o números, iniciando con letra. No caracteres especiales</small>
									</div>
							...
							<div class="row mb-2">
								...
								<div class="col text-center">
									<button type="submit" class="btn btn-warning text-center px-5 my-2" onclick="validar_pass()" name="personalizar" id="personalizar">Personaliza tu contraseña</button>
								</div>
								<div class="col"></div>
							</div>
					 </form>
