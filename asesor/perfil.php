...
<div class="mx-5 px-5 mt-3 mb-5 pb-5">
	...
	<div class="card shadow">
		<div class="card-header text-center text-dark-gray text-spaced-3">PERFIL DE ASESOR</div>
		<div class="card-body">

			<form action="<?php echo $RAIZ_SITIO; ?>scripts/asesor/modificar_perfil.php" method="post" class="mt-1" enctype="multipart/form-data">
				...
				<div class="form-row pb-1">
					<div class="form-group col-4">
						...
						<input type="text" class="form-control rounded text-center" name="nombre" id="nombre" aria-describedby="user_help" value="<?php echo $_SESSION['nombre']; ?>" disabled required>
				...
				<div class="form-row pb-1">
					<div class="form-group col-4">
						...
						<small id="carrera_help" class="form-text text-dark-gray w200">Selecciona tu profesión</small>
					</div>
					...
					<div class="form-group col-4">
						...
						<input type="text" class="form-control rounded text-center" name="trabajo" id="trabajo" aria-describedby="trabajo_help" value="<?php echo $_SESSION['trabajo']; ?>" disabled required>
						<small id="trabajo_help" class="form-text text-dark-gray w200">Lugar donde laboras</small>
					</div>
					<?php $validaciones[] = array('trabajo', 'trabajo_input', "'Error en Trabajo. Favor de corregir.'"); ?>
					<div class="form-group col-4">
						...
						<small id="puesto_help" class="form-text text-dark-gray w200">Puesto o cargo en tu trabajo</small>
					</div>
				...
				<div class="form-row pb-1">
					...
					<div class="form-group col-4">
						...
						<small id="tel_help" class="form-text text-dark-gray w200">Teléfono de contacto de tu trabajo</small>
					</div>
					<div class="form-group col-4">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$.ajax({
			...
			{
				$('#carrera').html("<option value=''>Selecciona tu profesión</option>" + data);
			}
		});
