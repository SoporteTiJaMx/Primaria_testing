...
if(
	...
	echo $query = "SELECT sesiones.Sesiones_ID, sesiones.Sesion_nombre, sesiones.Sesion_descripcion FROM sesiones INNER JOIN eventos ON sesiones.Sesiones_ID=eventos.Sesiones_ID WHERE eventos.Eventos_inicio < '" . $hoy . "' AND eventos.Licencia_ID = " . $Licencia_activa . " ORDER BY sesiones.Sesiones_ID ASC";
