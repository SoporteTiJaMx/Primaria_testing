<?php
	...
	$query = mysqli_query($con2, "SELECT DISTINCT licencia_escuela.Licencia_ID, licencias.Licencia_nombre FROM licencia_escuela LEFT JOIN licencias ON licencia_escuela.Licencia_ID = licencias.Licencia_ID WHERE licencia_escuela.Escuela_ID IN (SELECT Escuela_ID FROM empresas WHERE Asesor_ID=$Asesor_ID)");
	$_SESSION['licencia_activa'] = 0;
	$_SESSION['licencia_nombre'] = 0;
