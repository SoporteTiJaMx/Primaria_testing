...
<?php if ($_SESSION['licencia_activa']>0) { ?>
...
<?php } else { ?>
<h6 class="text-center text-dark_gray pt-1 pb-1">
	En este momento no tienes Empresa Juvenil asignada. <br>Ponte en contacto con JA México para que te vinculen a una Empresa Juvenil.
</h6>
<?php } ?>
