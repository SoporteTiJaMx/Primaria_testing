...
<div class="mx-lg-5 px-5 mt-3 mb-5 pb-5">

	<div class="card shadow">
		<div class="card-header text-center text-dark-gray text-spaced-3">PERFIL DE ADMINISTRADOR</div>
		<div class="card-body">

			<form action="<?php echo $RAIZ_SITIO; ?>scripts/admin/modificar_perfil.php" method="post" class="mt-1" enctype="multipart/form-data">
				...
				<div class="row text-center">
					<div class="custom-file mb-3 mt-1 offset-1 col-10 offset-lg-3 col-lg-6">
				...
				<div class="form-row pb-1">
					<div class="form-group col-12 col-lg-6">
						<label for="dir" class="control-label text-dark-gray">Domicilio:</label>
						<textarea type="text" class="form-control rounded" name="dir" id="dir" aria-describedby="dir_help" rows="2" disabled><?php echo $_SESSION['dir']; ?></textarea>
						<small id="dir_help" class="form-text text-dark-gray w200">Domicilio de contacto</small>
					</div>
				</div>
