...
if(
	...
	if (isset($_SESSION['licencia_activa'])) {
		...
		$select_empresa_acciones = "<option value='0'>Selecciona licencia activa</option>";
		$select_empresa_crowdfunding = "<option value='0'>Selecciona licencia activa</option>";
	}
