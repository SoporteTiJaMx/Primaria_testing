		...
		<nav class="navbar d-block d-lg-none navbar-light">
			...
			<?php if ($_SESSION["subseccion_general"]>43) { ?>
					<li class="nav-item <?php	if ($seccion == '5') { echo 'active'; } ?>">
						...
						<i class="fas fa-angle-right fa-fw mr-3"></i>Sesión 5 - La IdentidadEmpresarial <?php if (isset($_SESSION["sesion5"]) AND $_SESSION["sesion5"]==1) { ?><i class="fas fa-exclamation-circle fa-lg fa-fw faa-burst animated"></i><?php } ?>
					</a>
					</li>
			<?php } ?>
