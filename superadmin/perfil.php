...
<div class="toast" data-delay="5000" style="position: fixed; top: 10%; right: 2%; z-index: 2000;">
	...
	<div class="toast-body">
		Da click en el botón <span class="badge badge-warning text-center px-3 py-2">Modificar perfil</span> de abajo.
	</div>
</div>
...
<div class="mx-5 px-5 mt-3 mb-5 pb-5">
	...
	<div class="card shadow">
		<div class="card-header text-center text-dark-gray text-spaced-3">PERFIL DE USUARIO</div>
		<div class="card-body">

			<form action="<?php echo $RAIZ_SITIO; ?>scripts/superadmin/modificar_perfil.php" method="post" class="mt-1" enctype="multipart/form-data">
