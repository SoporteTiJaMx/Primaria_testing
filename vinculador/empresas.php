	...
	<div class="tab-pane fade" id="nav-crear" role="tabpanel" aria-labelledby="nav-crear-tab">
		...
		<div class="card shadow">
			...
			<div class="card-body">
				...
				<form action="<?php echo $RAIZ_SITIO; ?>scripts/vinculador/crear_usuario.php" method="post" class="mt-1">
...
<script type="text/javascript">
	$(document).ready(function(){
		$.ajax({
			url: '../vinculador/ajax/empresas_juveniles.php',
			type: 'post',
		...
		$.ajax({
			url: '../vinculador/ajax/num_empresas.php',
			type: 'post',
			success: function(data)
			{
